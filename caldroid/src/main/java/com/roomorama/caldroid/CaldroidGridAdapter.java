...
public class CaldroidGridAdapter extends BaseAdapter {
    ...
    protected void customizeTextView(int position, CellView cellView) {
        ...
        // Set text
        setInitialEvents(cellView, dateTime, "\nEvent 1");
    ...
    private void setInitialEvents(CellView cellView, DateTime dateTime, String eventTitle) {
        if(dateTime.format("YYYY-MM-DD").equals("2015-12-16")) {
            cellView.setText(String.valueOf(dateTime.getDay()) + eventTitle);
        }
        else {
