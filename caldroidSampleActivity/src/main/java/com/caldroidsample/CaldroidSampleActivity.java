...
//            args.putInt(CaldroidFragment.THEME_RESOURCE, com.caldroid.R.style.CaldroidDefaultDark);
        ...
        final CaldroidListener listener = new CaldroidListener() {
            ...
            public void onSelectDate(Date date, final View view) {
                /*Toast.makeText(getApplicationContext(), "Priya "+ formatter.format(date),
                ...
                LayoutInflater li = LayoutInflater.from(CaldroidSampleActivity.this);
                View promptsView = li.inflate(R.layout.event_input_alert, null);

                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(CaldroidSampleActivity.this);
